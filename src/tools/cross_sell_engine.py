    ...
    try:
        ...
        for offer in offers:
            ...
            if any(trigger in user_intent_lower for trigger in triggers):
                return f"[CROSS-SELL TRIGGERED] Partner: {offer['partner']} | Offer: {offer['details']}"
                
        return "[NO CROSS-SELL TRIGGERED] Maintain standard conversational flow."
