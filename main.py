...
# # ── Voice pipeline (Phase 2 - Currently Disabled) ───────────────────────────────────────────────────
# Voice input feature is complete but disabled for Phase 1 deployment.
# To enable: Uncomment the import and WebSocket route below.
# Requires: ffmpeg in tools/ directory, faster-whisper, websockets
...
if os.path.exists(frontend_dir):
    ...
    print(f"[Frontend] WARNING: frontend/ folder not found at {frontend_dir}")
